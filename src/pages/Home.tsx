...
function Home() {
	...
	useEffect(() => {
		const unListenTypingProgress = listen("progress-typing", (event) => {
			const packet = event.payload as TypingThreadProgress;
		...
		const unListenStartedTyping = listen("started-typing", () => setStage("typing"));
		const unListenTypingCancel = listen("cancel-key-pressed", () => {
